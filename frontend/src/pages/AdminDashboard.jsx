      ...
      <div className="w-full md:w-64 bg-brand-900 text-white flex flex-col shadow-xl shrink-0">
        <div className="p-4 sm:p-6 flex items-center justify-between border-b border-brand-800">
          <div className="flex items-center">
            ...
            <div>
              <span className="text-base sm:text-lg font-bold block leading-tight">Dhanvantri</span>
              <span className="text-[10px] sm:text-xs text-brand-300">Hospital Administration</span>
            </div>
          </div>
        ...
        <nav className="p-2 sm:p-4 flex md:flex-col gap-1.5 sm:gap-2 overflow-x-auto md:overflow-visible">
          ...
          <button
            onClick={openKiosk}
            className="flex items-center px-3 sm:px-4 py-2 sm:py-3 rounded-xl font-medium transition-all text-brand-100 hover:bg-brand-800/50 md:mt-4 border border-brand-700 whitespace-nowrap text-xs sm:text-sm"
          >
            <Monitor className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 text-green-400 shrink-0" /> Open Patient Kiosk
          </button>
        </nav>
        <div className="p-4 border-t border-brand-800 hidden md:block">
          <button onClick={handleSignOut} className="flex items-center w-full px-4 py-3 hover:bg-red-500/20 rounded-xl transition-colors text-red-300 hover:text-red-200 font-medium text-sm">
